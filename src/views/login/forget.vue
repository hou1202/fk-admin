    ...
    <div class="container-right">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
        ...
        <el-form-item prop="username">
          ...
          />
          <!-- <button>获取验证码</button> -->
          <el-button type="primary" style="height:36px;line-height:36px;padding:0 10px;position: absolute;right: 5px; top: 5px" @click="handleLogin">获取验证码</el-button>
        ...
        <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleLogin">重 置</el-button>

        <div class="a-footer">
          <a href="/" class="footer-right">返回登录</a>
        </div>
      </el-form>
